...
import { BusOffRouteComponent } from './bus-off-route.component';
...
describe('BusOffRouteComponent', () => {
    let component: BusOffRouteComponent;
    let fixture: ComponentFixture<BusOffRouteComponent>;

    beforeEach(async () => {
        await TestBed.configureTestingModule({
            imports: [TranslateModule.forRoot(), BusOffRouteComponent],
            providers: [provideHttpClient(), provideMockStore({ initialState: mockInitialState }), provideRouter([])],
            schemas: [NO_ERRORS_SCHEMA],
        }).compileComponents();

        fixture = TestBed.createComponent(BusOffRouteComponent);
        component = fixture.componentInstance;
        // Don't detect changes yet so we can test ngOnInit manually
    });
