...
@Component({
    selector: 'power-all-cv',
    imports: [MatIconModule, RouterModule, TranslateModule],
    templateUrl: './power-all-cv.component.html',
    styleUrls: ['./power-all-cv.component.scss'],
})
export class PowerAllCVComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.powerOn = !!this.activeRoute.snapshot.data['powerOn'];
